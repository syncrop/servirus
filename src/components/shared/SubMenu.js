                                    ...
                                    item.submenu ?
                                        <Menu as="div" className="">
                                            ...
                                            <Transition
                                                ...
                                                leaveTo="transform opacity-0 scale-95"
                                            >
                                                <Menu.Items className="animate fade absolute  z-10 ml-20  md:ml-48 -mt-[8rem] md:-mt-8 md:w-56 origin-top-right rounded-md bg-white shadow-lg ring-1  ring-black ring-opacity-5 focus:outline-none">
                                                            ...
                                                            <Menu.Item>
                                                                {({ active }) => (
                                                                    item.submenu ?
                                                                        ...
                                                                        :
                                                                        <NavLink to={item.url} onClick={closeEvent}
