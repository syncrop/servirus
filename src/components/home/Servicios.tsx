    ...
    return (
        <div className='bg-gray-200 p-8 flex flex-col items-center justify-center gap-8 py-16'>
            ...
            <div className='grid grid-cols md:grid-cols-4 items-center gap-12 text-xl md:text-lg md:text-xl text-gray-500'>
                <NavLink to={'/servicios/domotica'} className='transition-all duration-100 cursor-pointer hover:border-gray-500 border-2 hover:rounded-xl hover:shadow-2xl p-8 flex flex-col justify-center text-center'>
